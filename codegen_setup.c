...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Silent Bomber",
    .project_root_env = "SILENT_BOMBER_PROJECT_ROOT",
    .build_dir_env = "SILENT_BOMBER_BUILD_DIR",
    .force_setup_env = "SILENT_BOMBER_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_027.92_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Silent_Bomber_Recompiled",
    .prepare_note =
